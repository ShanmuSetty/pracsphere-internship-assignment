          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className={`text-xs mt-2 transition-colors duration-500 ${
                isDark ? 'text-[#70D56D]/60' : 'text-[#004643]/60'
              }`}>
            ...
            <div className="flex items-start">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 text-[#3DB876] bg-transparent border-[#3DB876] rounded focus:ring-2 focus:ring-[#00DFBB]/50"
                required
              />
              <label htmlFor="terms" className={`ml-3 text-sm transition-colors duration-500 ${
                isDark ? 'text-[#70D56D]/80' : 'text-[#004643]/70'
              }`}>
                I agree to the{" "}
                <button type="button" className={`font-medium transition-colors ${
